...
<body class="antialiased">
            ...
            <div class="w-full lg:w-5/6 max-w-screen-lg">
                <div class="rounded my-6">
                    <div class="pt-2 relative mx-auto text-gray-600">
                        ...
                        <br />
                        <input class="mb-4 w-96 border border-b-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none" type="search" name="search" placeholder="Recherche...">
  ...
  <svg class="fill-current text-white w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/></svg>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-900 font-semibold">Regional Paradigm Technician</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
